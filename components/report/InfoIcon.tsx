...
export function InfoIcon({ label }: { label?: string }) {
  return (
    <button
      ...
      className="ml-1 inline-flex h-[15px] w-[15px] shrink-0 items-center justify-center rounded-full align-middle text-muted/70 light:text-muted transition-colors hover:text-brand"
    >
